...
ORBextractorOCVOCL::ORBextractorOCVOCL(int _nfeatures, float _scaleFactor, int _nlevels,
...
void ORBextractorOCVOCL::operator()( cv::InputArray image, cv::InputArray mask,
...
void ORBextractorOCVOCL::computeImagePyramid(cv::InputArray image)
{
